...
export default async function TimePage({
  ...
  if (username) {
    try {
      ...
      error = err instanceof Error ? err.message : 'Unable to load time data.';
    }
  }
    ...
    <div className="page">
      <section className="page-header">
        <div>
          ...
          <p>Elite-level clock management analysis with phase-by-phase breakdown.</p>
        </div>
      </section>
      ...
      <section className="card">
        <form className="filters" method="get">
          <div className="field full">
            ...
            <p className="muted">
              Analyzing time management for <strong>{username ?? '—'}</strong>. Update this in{' '}
      ...
      {!username ? (
        <section className="card">
          <h3>Get started</h3>
          <p className="muted">Set your Chess.com username in settings to analyze your time management.</p>
        ...
        <section className="card">
          <h3>Unable to load time data</h3>
        ...
        <TimeManagementClient 
          username={username} 
          gameLimit={gameLimit}
          timeManagement={insightsData.time_management}
