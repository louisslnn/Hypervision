...
import { getClassificationLabel } from "./moveClassifier.js";
 ...
 */
export async function generateMoveCoachFeedback(apiKey, moveContext) {
 ...
 */
function getFallbackFeedback(ctx) {
    return {
...
function getFallbackExplanation(ctx) {
    const color = ctx.isWhiteMove ? "White" : "Black";
...
function getFallbackTips(classification) {
...
function getEncouragement(classification) {
    switch (classification) {
        case "best":
 ...
 */
export function generateQuickFeedback(ctx) {
